...
export const searchDocumentsSystem = <ThrowOnError extends boolean = false>(options?: Options<SearchDocumentsSystemData, ThrowOnError>): RequestResult<SearchDocumentsSystemResponses, SearchDocumentsSystemErrors, ThrowOnError> => (options?.client ?? client).get<SearchDocumentsSystemResponses, SearchDocumentsSystemErrors, ThrowOnError>({ url: '/api/v1/documents-system/search', ...options });
