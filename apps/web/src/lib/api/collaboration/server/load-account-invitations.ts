...
export type LoadAccountInvitationsQuery = Readonly<
  NonNullable<GetAccountInvitationsData["query"]>
>;

export async function loadAccountInvitations(
  query: LoadAccountInvitationsQuery = {},
): Promise<ApiResult<AccountInvitationPageResponse>> {
