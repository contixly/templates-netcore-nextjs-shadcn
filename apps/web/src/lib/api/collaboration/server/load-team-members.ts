...
import { getTeamMembers } from "@/src/lib/api/generated/sdk.gen";
import type {
  GetTeamMembersData,
...
export type LoadTeamMembersQuery = Readonly<
  NonNullable<GetTeamMembersData["query"]>
>;
...
): Promise<ApiResult<TeamMemberPageResponse>> {
