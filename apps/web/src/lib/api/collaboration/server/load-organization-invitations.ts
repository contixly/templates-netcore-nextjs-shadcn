...
export type LoadOrganizationInvitationsQuery = Readonly<
  NonNullable<GetOrganizationInvitationsData["query"]>
>;

export async function loadOrganizationInvitations(
  organizationId: string,
  query: LoadOrganizationInvitationsQuery = {},
): Promise<ApiResult<OrganizationInvitationPageResponse>> {
