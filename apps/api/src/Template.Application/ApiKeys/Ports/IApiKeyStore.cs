...
public interface IApiKeyStore
{
    ...
    Task<ApiKeyOperationResult<ApiKeySummary>> UpdateAsync(UpdateApiKeyStoreCommand command, CancellationToken cancellationToken);
    ...
    Task<ApiKeyAuthenticationResult> AuthenticateAndConsumeAsync(byte[] hash, CancellationToken cancellationToken);
}
