...
| `dotnet restore Template.sln && dotnet build Template.sln --no-restore && dotnet test Template.sln --no-restore`                                                                                                                                                                                                                                                                  | PASS; build 0 warnings/errors, Application 17/17 and API 102/102: 119/119 total                                                                                         |
| repeat OpenAPI export with `-p:OpenApiGenerateDocuments=true` and compare SHA-256                                                                                                                                                                                                                                                                                                 | PASS; deterministic OpenAPI 3.1 artifact, SHA-256 `bcdc582ab1a63ef6439da5e201d6d658e8dc62c45a5c948fa9449ccb14f7e320`                                                    |
...
| `npm run format:check && npm run lint && npm run typecheck && npm test -- --runInBand`                                                                                                                                                                                                                                                                                            | PASS; Prettier, ESLint, Next route generation, `tsc --noEmit`, Jest 24/24 suites and 94/94 tests                                                                        |
| targeted Prettier check for the six updated durable Markdown files                                                                                                                                                                                                                                                                                                                | PASS; all updated docs use Prettier formatting                                                                                                                          |
